...
export default async function AnalyticsPage({
  ...
  searchParams: { interval?: string; timezone?: string; productId?: string };
}) {
  ...
  const intervalKey = await searchParams.interval;
  const interval =
    CHART_INTERVALS[intervalKey as keyof typeof CHART_INTERVALS] ??
